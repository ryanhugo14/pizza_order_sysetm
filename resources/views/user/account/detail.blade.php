        ...
        <div class="w-full">
            @if (session('updateSuccess'))
                <div class="flex justify-start lg:justify-end">
                    <div id="alert-2" class="flex p-4 mb-4 bg-green-100 rounded-lg  w-full md:w-[60%] lg:w-[40%]"
                        role="alert">
            ...
            @endif
            <a href="{{ route('user#homePage') }}" class="absolute left-2 md:left-6 lg:left-20 -top-2 flex items-center">
                <i class="fa-solid fa-left-long text-xl mr-2"></i>
                <span class="font-semibold">Back</span>
            </a>
            <div class="w-full shadow-lg bg-white p-10 pt-16 pb-10 rounded-lg">
                <div class="flex justify-center">
                    <h1 class="text-center text-5xl font-bold border-b-4 pb-2 border-yellow-500 inline-block ">Your Details
                    </h1>
                </div>
                <div
                    class="mt-20 flex flex-col md:flex-row items-center justify-center space-y-14 md:space-y-0 md:space-x-32">
                    <div class="flex  flex-col space-y-20 items-center justify-center">
                        ...
                        @else
                            <img src="{{ asset('storage/' . Auth::user()->image) }}" alt=""
                                class="bg-contain w-48  h-48   rounded-full ">
                        @endif
                        <a href="{{ route('user#editPage') }}" class="hidden md:inline-block">
                            <button class="w-44  px-3 py-2 bg-yellow-500 font-semibold text-white rounded-md">Edit
                                Details</button>
                        </a>
                    </div>
                    <div class="space-y-5">
                    ...
                    <div class="md:hidden mt-16 w-full">
                        <a href="{{ route('user#editPage') }}">
                            <button class="w-full  px-3 py-2 bg-yellow-500 font-semibold text-white rounded-lg">Edit Details</button>
                        </a>
                    </div>
                </div>
            </div>
